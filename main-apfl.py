...
if __name__ == '__main__':
    ...
    for iter in range(args.epochs):
        ...
        if iter % args.round == args.round-1:
            ...
            model_save_path = './save/APFL/accs_APFL_memory_'+str(args.lamb) +str('_') + args.alg + '_' + args.dataset + '_' + str(args.num_users) + '_' + str(
    ...
    print(times)
    print(accs)
    base_dir = './save/APFL/accs_APFL_lambda_'+str(args.lamb) +str('_') + args.alg + '_' + args.dataset + '_' + str(args.num_users) + '_' + str(

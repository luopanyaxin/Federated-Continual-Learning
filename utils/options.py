...
def args_parser():
    ...
    # federated arguments
    parser.add_argument('--epochs', type=int, default=75, help="rounds of training")
    ...
    parser.add_argument('--task', type=int, default=5, help='train number of task')
    parser.add_argument('--lamb', default=0, type=float, help='(default=%(default)f)')
    parser.add_argument('--n_memories', type=int, default=200,
